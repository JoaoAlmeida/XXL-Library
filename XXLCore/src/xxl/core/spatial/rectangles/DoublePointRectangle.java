...
public class DoublePointRectangle implements Rectangle {
	...
	*/
	 ...
	 * 
	 * @param leftCorner double array representing lower-left corner of the rectangle
	 * @param rightCorner  double array representing upper-right corner of the rectangle
	*/
	public DoublePointRectangle(double[] leftCorner, double[] rightCorner) {
        ...
        public DoublePointRectangle(double[] leftCorner, double[] rightCorner, double score) {
		if (leftCorner.length != rightCorner.length)
			throw new IllegalArgumentException("dimensions must be equal!");
		this.leftCorner = leftCorner;
		this.rightCorner = rightCorner;
